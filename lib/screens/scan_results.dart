        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Freshness info card
              _buildInfoCard(
                icon: freshness.toLowerCase() == 'fresh'
                    ? Icons.check_circle
                    : freshness.toLowerCase() == 'moderate'
                    ? Icons.warning
                    : Icons.error,
              ...
              // Action Buttons
              /*  // Back to Scan button (commented out)
              Container(
                height: 56,
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
